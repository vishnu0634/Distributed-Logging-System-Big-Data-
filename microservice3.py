...
class Microservice:
    def __init__(self, service_name):
        ...
        self.node_id = str(uuid.uuid4())  # Generate unique node ID
        self.log_file = os.path.join(os.path.dirname(__file__), "microservice3.log")  # Local log file path
...
if __name__ == "__main__":
    service = Microservice(service_name="PaymentService")
    service.start()
